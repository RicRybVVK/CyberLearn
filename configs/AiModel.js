  ...
  const contents = [
    {
      ...
      parts: [
        {
          text: `Generate a study material for Cybersecurity basics for Security Awareness and level of difficulty will be EASY with summary of course, List of Chapters along with summery for each chapter, Topic list in each chapter, all result in JSON format`,
        },
      ],
    },
    {
      ...
      parts: [
        {
          text: `Okay, I can help you generate study material for Cybersecurity basics for Security Awareness at an easy level of difficulty, summarized in JSON format.

\`\`\`json
{
  "courseTitle": "Cybersecurity Basics for Security Awareness",
  "level": "Easy",
  "summary": "This course provides a foundational understanding of cybersecurity principles and practices to help individuals protect themselves and their organizations from cyber threats. It focuses on practical knowledge and skills to promote security awareness and responsible online behavior.",
  "chapters": [
    {
      "chapterNumber": 1,
      "chapterTitle": "Introduction to Cybersecurity",
      "summary": "This chapter introduces the core concepts of cybersecurity, explaining what it is, why it matters, and the different types of threats individuals and organizations face.",
      "topics": [
        "What is Cybersecurity?",
        "Why is Cybersecurity Important?",
        "Common Cyber Threats (Malware, Phishing, Hacking)",
        "Basic Security Principles (Confidentiality, Integrity, Availability)",
        "The Role of Security Awareness"
      ]
    },
    {
      "chapterNumber": 2,
      "chapterTitle": "Passwords and Authentication",
      "summary": "This chapter covers the importance of strong passwords and secure authentication methods to protect accounts and data.",
      "topics": [
    ...
    {
      "chapterNumber": 3,
      "chapterTitle": "Phishing and Social Engineering",
      "summary": "This chapter focuses on identifying and avoiding phishing attempts and other social engineering tactics used by cybercriminals.",
      "topics": [
        "What is Phishing?",
    ...
    {
      "chapterNumber": 4,
      "chapterTitle": "Malware Awareness",
      "summary": "This chapter introduces different types of malware and how to protect systems from infection.",
      "topics": [
        "What is Malware?",
        "Types of Malware (Viruses, Worms, Trojans, Ransomware)",
        "How Malware Spreads",
        "Protecting Against Malware (Antivirus Software, Safe Browsing)",
        "What to Do If Infected"
      ]
    },
    {
      "chapterNumber": 5,
      "chapterTitle": "Safe Internet Practices",
      "summary": "This chapter covers best practices for browsing the internet safely and securely.",
      "topics": [
    ...
    {
      "chapterNumber": 6,
      "chapterTitle": "Data Protection and Privacy",
      "summary": "This chapter emphasizes the importance of protecting sensitive data and respecting privacy.",
      "topics": [
    ...
    {
      "chapterNumber": 7,
      "chapterTitle": "Physical Security",
      "summary": "This chapter covers the basics of physical security measures to protect devices and information.",
      "topics": [
        "Securing Devices (Laptops, Mobile Phones)",
    ...
    {
      "chapterNumber": 8,
      "chapterTitle": "Incident Reporting",
      "summary": "This chapter explains the importance of reporting security incidents and how to do so effectively.",
      "topics": [
        "What is a Security Incident?",
        "Why Report Incidents?",
        "How to Report Incidents (Company Procedures)",
        "Who to Contact",
